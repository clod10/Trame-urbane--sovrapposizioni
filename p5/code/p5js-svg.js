  ...
  function Filters(p5) {
    ...
    p5.prototype.filter = function (operation, value) {
      ...
      if (svg) {
        ...
        rootGroup.appendChild(g.elt);
        if (
          ctx.__currentElement.isWithinUserInstanciated &&
          ctx.__currentElement.isWithinUserInstanciated()
        ) {
          console.warn(
            "Filter will promptly exit out of any instanciated group. Please make sure you've exited them before filtering"
          );
        }
